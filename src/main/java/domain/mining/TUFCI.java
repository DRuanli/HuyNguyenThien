...
public class TUFCI extends AbstractMiner {
    ...
    /**
     * Constructs a new TUFCI miner with default parallelization (DEFAULT - fully sequential).
     *
    ...
    public TUFCI(UncertainDatabase database, double tau, int k) {
        this(database, tau, k, ParallelizationMode.DEFAULT);
    }

    /**
     * Constructs a new TUFCI miner with specified parallelization mode.
     *
     * @param database The uncertain database to mine
    ...
    /**
     * Constructor with custom support calculator (parallelization mode inferred).
     *
    ...
    public TUFCI(UncertainDatabase database, double tau, int k,
        ...
        super(database, tau, k, calculator, ParallelizationMode.DEFAULT);
    }
