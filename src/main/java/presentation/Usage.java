...
public class Usage {
    ...
    public static void printUsage() {
        ...
        System.out.println("  java -cp bin presentation.Main <database_file> [tau] [k] [options]");
        System.out.println();
        System.out.println("Positional Arguments:");
        System.out.println("  database_file : Path to the uncertain database file (required)");
        System.out.println("  tau           : Probability threshold τ ∈ [0,1] (optional, default: 0.7)");
        ...
        System.out.println("  --output-patterns <file> : Export top-K patterns to CSV");
        System.out.println("  --quiet                  : Suppress console output (print CSV line only)");
        System.out.println();
        ...
        System.out.println();
        System.out.println("  # Batch processing (quiet mode)");
        System.out.println("  for k in 10 50 100; do");
        System.out.println("    java -cp bin presentation.Main data/retail_uncertain.txt 0.7 $k \\");
        System.out.println("         --quiet >> results.csv");
        System.out.println("  done");
        System.out.println();
        System.out.println("For detailed documentation, see REPRODUCIBILITY.md");
        System.out.println();
    }
