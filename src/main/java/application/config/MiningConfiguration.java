...
public class MiningConfiguration {
    ...
    /**
     * Returns the parallelization mode.
     *
    ...
    public String toString() {
        return String.format("MiningConfig[db=%s, tau=%.2f, k=%d, algo=%s, parallel=%s]",
                           databasePath, tau, k, algorithmName, parallelizationMode.getCliValue());
    }
    ...
    public static class Builder {
        ...
        /**
         * Sets the parallelization mode.
         *
         * @param mode the parallelization mode (NONE, PHASE1_ONLY, SUPPORT_ONLY, or FULL)
         * @return this builder for method chaining
         */
        public Builder parallelizationMode(ParallelizationMode mode) {
